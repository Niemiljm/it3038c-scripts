...
Example 1: An example of a simple comparative graph: (https://github.com/Niemiljm/it3038c-scripts/blob/main/Python/Lab7/Images/FirstGraph.png)
Example 2: The two lines that were in example 1, but in separate graphs: (https://github.com/Niemiljm/it3038c-scripts/blob/main/Python/Lab7/Images/SecondGraph.png)
Example 3: 6 Generated graphs, 2 of which have data in them based on coordinates: (https://github.com/Niemiljm/it3038c-scripts/blob/main/Python/Lab7/Images/ThirdGraph.png)
Example 4: A cool looking colormap that was generated: (https://github.com/Niemiljm/it3038c-scripts/blob/main/Python/Lab7/Images/FourthGraph.png)
